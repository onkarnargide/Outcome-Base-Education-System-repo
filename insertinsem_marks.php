...
$sql = "INSERT INTO insem (s_rollno, Q1a, Q1b, Q2a, Q2b, Q3a, Q3b, Q4a, Q4b, Q5a, Q5b, Q6a, Q6b,total) VALUES ('$s_rollno', '$Q1a','$Q1b','$Q2a','$Q2b','$Q3a','$Q3b','$Q4a','$Q4b','$Q5a','$Q5b','$Q6a','$Q6b','$total')";
if(mysqli_query($link, $sql)){
    // echo "Record added successfully.";
    header("Location: viewinsem_marks.php");
	die();
} else{
