    ...
    background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
      <div class="container">
        <div class="d-flex bd-highlight mb-3">
          <div class="mr-auto p-2 bd-highlight"><h3>View Student Information</h3></div>
            ...
            <div>
              <table>
                ...
                <?php
                  ...
                  $sql = "SELECT s_rollno,s_name,gender,dob,class,dept_name,academic_year,sem from stud";
                  $result = $connection -> query($sql);

                  if ($result-> num_rows > 0) {
                    while ($row = $result-> fetch_assoc()) {
                      echo "<tr><td>". $row["s_rollno"] ."</td><td>" . $row["s_name"] ."</td><td>" . $row["gender"] ."</td><td>" .$row["dob"] ."</td><td>" .  $row["class"] ."</td><td>" . $row["dept_name"] ."</td><td>".$row["academic_year"] ."</td><td>" . $row["sem"] ."</td></tr>";
                    }
                    echo"</table>";
