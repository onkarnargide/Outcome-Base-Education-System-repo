...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
     ...
     <!-- View Student Marks -->
    <h2 class="display-5 pl-5"><i class="fas fa-users pr-2"></i> Insem Marks Distribution</h2>
    <hr style=" border: 0;
    height: 1px;
    background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
      <div class="container-fluid">
        <div class="d-flex flex-row justify-content-between ">
          ...
          <a class="btn btn-outline-success" href="addinsem_marks.php">Add marks for a student</a>
        </div>
            <div>
              <table>
                <tr>
                ...
                <?php
                  ...
                  $sql = "SELECT i.s_rollno,s.s_name,i.Q1a,i.Q1b,i.Q2a,i.Q2b,i.Q3a,i.Q3b,i.Q4a,i.Q4b,i.Q5a,i.Q5b,i.Q6a,i.Q6b,i.total from stud s , insem i where s.s_rollno = i.s_rollno";
