  ...
  <body>
    ...
    background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
      <blockquote class="blockquote">
        <p class="mb-0">Select the <mark>exam</mark> whose result you want to see.</p>
      </blockquote>
  ...
  <div class="col-sm-6">
    <div class="card border-info mb-3">
      <div class="card-body">
        ...
        <a href="viewinsem_marks.php" class="btn btn-outline-info btn-lg btn-block">Prelim Insem</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card border-info mb-3">
      <div class="card-body">
        ...
        <a href="viewprelim_marks.php" class="btn btn-outline-info btn-lg btn-block">Prelim </a>
      </div>
    </div>
  </div>
</div>
